...
public class RelyingPartyMetadata extends BasicClientMetadata {
  ...
  @JsonIgnore
  @Getter private static final OidcLangJsonSerializer<RelyingPartyMetadata> jsonSerializer =
  ...
  @Getter @Setter private String applicationType;
  ...
  @Getter @Setter private String sectorIdentifierUri;
  ...
  @Getter @Setter private String subjectType;
  ...
  @Getter @Setter private String idTokenSignedResponseAlg;
  ...
  @Getter @Setter private String idTokenEncryptedResponseAlg;
  ...
  @Getter @Setter private String userinfoSignedResponseAlg;
  ...
  @Getter @Setter private String userinfoEncryptedResponseAlg;
  ...
  @Getter @Setter private String userinfoEncryptedResponseEnc;
  ...
  @Getter @Setter private String requestObjectSigningAlg;
   ...
   * when this parameter is present. If both signing and encryption are requested, the Request Object will be signed then
   * encrypted, with the result being a Nested JWT, as defined in [JWT]. The default, if omitted, is that the RP is not
   * declaring whether it might encrypt any Request Objects.
   *
   */
  @JsonProperty("request_object_encryption_alg")
  @Getter @Setter private String requestObjectEncryptionAlg;
  ...
  @Getter @Setter private String requestObjectEncryptionEnc;
  ...
  @Getter @Setter private String tokenEndpointAuthSigningAlg;
  ...
  @Getter @Setter private Integer defaultMaxAge;
  ...
  @Getter @Setter private Boolean requireAuthTime;
   ...
   *   parameter. The acr_values_supported discovery element contains a list of the supported acr values supported by
   *   this server. Values specified in the acr_values request parameter or an individual acr Claim request override
   *   these default values.
   */
  @JsonProperty("default_acr_values")
  @Getter @Setter private List<String> defaultAcrValues;
  ...
  @Getter @Setter private String initiateLoginUri;
  ...
  @Getter @Setter private String requestUris;
   ...
   */
  public static class RelyingPartyMetadataBuilder extends BasicClientMetadataBuilder<RelyingPartyMetadata, RelyingPartyMetadataBuilder> {
    ...
    /** {@inheritDoc} */
    @Override RelyingPartyMetadataBuilder getReturnedBuilderInstance() {
      return this;
    }

    public RelyingPartyMetadataBuilder applicationType(String applicationType){
      this.metadata.applicationType = applicationType;
      return this;
    }
    public RelyingPartyMetadataBuilder sectorIdentifierUri(String sectorIdentifierUri){
      this.metadata.sectorIdentifierUri = sectorIdentifierUri;
      return this;
    }
    public RelyingPartyMetadataBuilder subjectType(String subjectType){
      this.metadata.subjectType = subjectType;
      return this;
    }
    public RelyingPartyMetadataBuilder idTokenSignedResponseAlg(String idTokenSignedResponseAlg){
      this.metadata.idTokenSignedResponseAlg = idTokenSignedResponseAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder idTokenEncryptedResponseAlg(String idTokenEncryptedResponseAlg){
      this.metadata.idTokenEncryptedResponseAlg = idTokenEncryptedResponseAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder userinfoSignedResponseAlg(String userinfoSignedResponseAlg){
      this.metadata.userinfoSignedResponseAlg = userinfoSignedResponseAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder userinfoEncryptedResponseAlg(String userinfoEncryptedResponseAlg){
      this.metadata.userinfoEncryptedResponseAlg = userinfoEncryptedResponseAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder userinfoEncryptedResponseEnc(String userinfoEncryptedResponseEnc){
      this.metadata.userinfoEncryptedResponseEnc = userinfoEncryptedResponseEnc;
      return this;
    }
    public RelyingPartyMetadataBuilder requestObjectSigningAlg(String requestObjectSigningAlg){
      this.metadata.requestObjectSigningAlg = requestObjectSigningAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder requestObjectEncryptionAlg(String requestObjectEncryptionAlg){
      this.metadata.requestObjectEncryptionAlg = requestObjectEncryptionAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder requestObjectEncryptionEnc(String requestObjectEncryptionEnc){
      this.metadata.requestObjectEncryptionEnc = requestObjectEncryptionEnc;
      return this;
    }
    public RelyingPartyMetadataBuilder tokenEndpointAuthSigningAlg(String tokenEndpointAuthSigningAlg){
      this.metadata.tokenEndpointAuthSigningAlg = tokenEndpointAuthSigningAlg;
      return this;
    }
    public RelyingPartyMetadataBuilder defaultMaxAge(Integer defaultMaxAge){
      this.metadata.defaultMaxAge = defaultMaxAge;
      return this;
    }
    public RelyingPartyMetadataBuilder requireAuthTime(Boolean requireAuthTime){
      this.metadata.requireAuthTime = requireAuthTime;
      return this;
    }
    public RelyingPartyMetadataBuilder defaultAcrValues(List<String> defaultAcrValues){
      this.metadata.defaultAcrValues = defaultAcrValues;
      return this;
    }
    public RelyingPartyMetadataBuilder initiateLoginUri(String initiateLoginUri){
      this.metadata.initiateLoginUri = initiateLoginUri;
      return this;
    }
    public RelyingPartyMetadataBuilder requestUris(String requestUris){
      this.metadata.requestUris = requestUris;
      return this;
    }

    /** {@inheritDoc} */
    @Override public RelyingPartyMetadata build() {
      return metadata;
    }
  }
}
